...
/** 代码重构：用代码把功能实现以后，考虑代码结构如何编写可以方便后期维护 */
-(UIWindow *)window{
    if (!_window) {
...
-(RESideMenu *)sideMenu{
    if (!_sideMenu) {
        _sideMenu = [[RESideMenu alloc]initWithContentViewController:[XiMaLaYaController defaultNavi] leftMenuViewController:[LeftController new] rightMenuViewController:nil];
